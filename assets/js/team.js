const team_a = document.getElementById("teama").innerHTML;
const team_b = document.getElementById("teamb").innerHTML;
const team_c = document.getElementById("teamc").innerHTML;
