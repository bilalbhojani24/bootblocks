const form_a = document.getElementById("forma").innerHTML;
const form_b = document.getElementById("formb").innerHTML;
const form_c = document.getElementById("formc").innerHTML;
